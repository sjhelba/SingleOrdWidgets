...
////////////////////////////////////////////////////////////////
	...
	const setupDefinitions = widget => {
		...
		console.log('widget.value()', data.value);
		
		if (data.value) {

			const preset = data.value.get('preset')
			console.log('Preset', preset)
			const preset2 = data.value.getSlot('preset')
			console.log('Preset2', preset2)

			const enabled = data.value.get('enabled')
			console.log('Enabled', enabled)
			const enabled2 = data.value.getSlot('enabled')
			console.log('Enabled2', enabled2)

		} else {

			console.log('data.value is falsey')
